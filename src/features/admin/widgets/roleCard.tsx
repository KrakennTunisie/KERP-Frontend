...
import { Permission, PermissionCategory } from "../mocks/mock-permission";
...
export function RoleCard(
  ...
  const groupedPermissions = useMemo<Record<PermissionCategory, Permission[]>>(() => {
  ...
  const onRevoke = (permission: Permission, )=>{
