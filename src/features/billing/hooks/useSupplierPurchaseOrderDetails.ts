...
export default function useSupplierPurchaseOrderDetails({purchaseOrderId}:PurchaseOrderDetailsProps) {
    ...
    const fetchPurchaseOrder = async () => {
        try {
          ...
          const purchaseOrder = await PurchaseOrderAPI.getSupplierPurchaseOrderById(purchaseOrderId);
