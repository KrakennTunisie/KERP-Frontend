        ...
        actionItems={[
          {
            ...
            visible: payment.paymentStatus != paymentStatusTypeSchema.enum.SENT
          },
          {
          ...
          },
          {
            ...
            visible: payment.paymentStatus != paymentStatusTypeSchema.enum.SENT && payment.invoice.partner.email != ""
          },
          {
            label: "Supprimer",
            icon: Trash2,
