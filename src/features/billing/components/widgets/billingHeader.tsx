...
<div className="mb-5 flex flex-col gap-3 border-b border-slate-100 pb-4 font-[Inter,system-ui,sans-serif] md:flex-row md:items-center md:justify-between">
  ...
  <div>
    {rightContent ? (
      ...
      <Link
        href={createHref!}
        className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg bg-blue-600 px-3.5 text-[11px] font-semibold text-white shadow-sm transition-colors hover:bg-blue-700"
      >
