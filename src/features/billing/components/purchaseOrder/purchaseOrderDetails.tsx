          ...
          <div className="space-y-2.5 mb-4 divide-y divide-gray-100">
            <div className="flex items-center gap-2.5 py-2.5">
              ...
              <p className="text-xs text-gray-700">
                {purchaseOrder?.partner?.professionnalPhoneNumber || "Aucun numéro de téléphone disponible"}
              </p>
            </div>
            ...
            <div className="flex items-center gap-2.5 py-2.5">
              ...
              <p className="text-xs text-gray-700">{purchaseOrder?.partner?.billingAddress!.region || "Aucun Adresse disponible"}</p>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-gray-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-gray-900 font-mono">{purchaseOrder?.partner?.taxRegistrationNumber || "Aucun Matricule fiscale disponible"}</p>
              </div>
            </div>
          </div>
        </Card>
