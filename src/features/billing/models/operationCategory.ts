...
export type OperationCategory = z.infer<
  typeof OperationCategorySchema
>;

export const CreateOperationCategorySchema =
  CreateSettingSchema.extend({});

export type CreateOperationCategory = z.infer<
  typeof CreateOperationCategorySchema
>;

export const UpdateOperationCategorySchema =
  UpdateSettingSchema.extend({});
