...
export const partnersApi = {
  ...
  getPurchaseOrderByPartnerId:(id :string, query? : GetListParams) => 
    apiClient.get<PageResponse<PurchaseOrderPartnerSummary>>(PURCHASE_ORDER_ENDPOINTS.getPurchaseOrderByIdPartner(id, query)),
};
